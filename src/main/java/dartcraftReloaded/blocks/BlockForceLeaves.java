...
import static dartcraftReloaded.Constants.FORCE_LEAVES;
...
public class BlockForceLeaves extends BlockLeaves {
    ...
    public BlockForceLeaves() {
        ...
        this.setRegistryName(FORCE_LEAVES);
        this.setTranslationKey(FORCE_LEAVES);
    ...
    public void registerItemModel(Item itemBlock) {
        DartcraftReloaded.proxy.registerItemRenderer(itemBlock, 0, FORCE_LEAVES);
    }
