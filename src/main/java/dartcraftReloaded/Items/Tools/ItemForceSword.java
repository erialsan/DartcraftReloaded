...
public class ItemForceSword extends ItemSword {
    ...
    public ActionResult<ItemStack> onItemRightClick(World worldIn, EntityPlayer playerIn, EnumHand handIn) {
        ...
        if(heldStack.hasCapability(DCRCapabilityHandler.CAPABILITY_TOOLMOD, null)) {
            if(heldStack.getCapability(DCRCapabilityHandler.CAPABILITY_TOOLMOD, null).hasWing()) {
    ...
    public void addInformation(ItemStack stack, @Nullable World worldIn, List toolTip, ITooltipFlag flagIn) {
        if(stack.getCapability(DCRCapabilityHandler.CAPABILITY_TOOLMOD, null).hasWing())
            toolTip.add("Wing");
        if(stack.getCapability(DCRCapabilityHandler.CAPABILITY_TOOLMOD, null).hasBleed())
            toolTip.add("Bleeding " + stack.getCapability(DCRCapabilityHandler.CAPABILITY_TOOLMOD, null).getBleedLevel());
    }
