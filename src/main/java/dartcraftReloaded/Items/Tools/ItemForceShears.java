...
public class ItemForceShears extends ItemShears {
    ...
    public boolean itemInteractionForEntity(ItemStack itemstack, EntityPlayer player, EntityLivingBase entity, EnumHand hand) {
        ...
        if(itemstack.getCapability(DCRCapabilityHandler.CAPABILITY_TOOLMOD, null).hasRainbow()) {
    ...
    public void addInformation(ItemStack stack, @Nullable World worldIn, List<String> tooltip, ITooltipFlag flagIn) {
        if(stack.getCapability(DCRCapabilityHandler.CAPABILITY_TOOLMOD, null).hasRainbow())
            tooltip.add("Rainbow");
