...
public class ItemForceMitt extends ItemTool {
    ...
    public ItemForceMitt() {
        ...
        this.setRegistryName(Constants.FORCE_MITT);
        this.setTranslationKey(Constants.FORCE_MITT);
    ...
    public void registerItemModel() {
        DartcraftReloaded.proxy.registerItemRenderer(this, 0, Constants.FORCE_MITT);
    }
